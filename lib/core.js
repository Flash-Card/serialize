...
module.exports.src = function (serializer, iterator, getter, setter) {
...
module.exports.dst = function (serializer, getter, setter) {
  ...
  var iterator = Object.keys(serializer);
  var cAccessor = function (data, V) {
    return accessor(serializer, getter, data, V);
  };
  return function (data) {
    return iterator.reduce(function (A, V) {
...
module.exports.create = function (list) {
  ...
  for (var i = 0; i < list.length; i++) {
    propery = list[i];
    obj = helpers.assignProperty(obj, propery, value(propery));
  }
